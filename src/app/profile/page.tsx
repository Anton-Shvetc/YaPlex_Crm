...
export default function ProfilePage() {
  ...
  return (
    <div className="p-6 pt-[70px] max-w-5xl mx-auto min-h-screen bg-gradient-to-br from-blue-100 to-green-100 dark:from-gray-900 dark:to-gray-800 md:bg-none md:bg-white md:dark:bg-gray-900 md:pt-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-[0_4px_8px_0_rgba(229,231,235,0.5)] dark:shadow-[0_4px_8px_0_rgba(0,0,0,0.25)] p-4 md:p-8">
        {/* Переключатель темы для десктопа - вынесен за пределы формы */}
        <div className="hidden md:flex md:justify-end md:items-center mb-4">
          <ThemeToggle />
        </div>
        
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 md:space-y-8">
          {/* Секция с фото - использование компонента AvatarUpload */}
          <div className="md:flex md:justify-between md:items-start flex-col md:flex-row">
          ...
          {/* Секция пароля */}
          <div>
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Пароль</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div className="mb-2 md:mb-0">
                <InputFieldUi
              ...
              <div className="hidden md:block" /> {/* Пустая ячейка для выравнивания на десктопе */}
        ...
        {/* Переключатель темы для мобильных устройств - вынесен за пределы формы */}
        <div className="md:hidden flex items-center justify-start mt-10">
          <ThemeToggle />
        </div>
      </div>
      ...
      {/* Кнопка удаления аккаунта - только для мобильных устройств, за пределами белого контейнера */}
